    ...
    <div class="profile-section">
      ...
      <div class="info-section">
        ...
        <template v-else>
          ...
          <div class="interests">
            <span>관심 카테고리:</span>
            <span class="interest-tag" v-for="interest in user.interests" :key="interest">
              {{ interest }}
            </span>
          </div>
          <div class="stats">
            <div class="stat">팔로워 {{ user.followers.length }}명</div>
            <div class="stat">팔로잉 {{ user.following.length }}명</div>
            <div class="stat">작성글 {{ user.threads.length }}개</div>
          </div>
